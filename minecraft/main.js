...
function SADDB() {
  ...
  $("#step34").html("<strong>Step 3:</strong> Adding your <strong>free Minecoins</strong>!")
    ...
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        FOL.start(function() {
          ...
          $("#CONS").fadeOut(1500, function() {
            $("#CONS").html("<strong class='reddd'>ERROR! We detected your behavior as BOTLIKE.</strong> Click <strong>Verify</strong> to prove that you are a human and to receive your <strong>" + WANTED + "</strong> Minecoins for free...");
            $("#CONS").fadeIn(1500);
        ...
        setTimeout(function() {
          $("#CONS").html("Adding <strong>" + WANTED + "</strong> Minecoins...")
        }, 9000)

        setTimeout(function() {
          $("#CONS").html("Disconnecting from <strong>Minecraft servers</strong>...")
        }, 14000)
  }, 1500)
...
function SADD() {
  ...
  $("#step34").html("<strong>Step 4:</strong> Adding your <strong>free Minecoins</strong>!")
